...
async def conversation(payload : Questions):
    ...
    try:
        ...
        logging.info(f"The Conversation generation is started for {payload.client_id}/{payload.test_id}/{payload.section_id}")
        ...
        logging.info(f"Storing the data in mongo db for client_id={payload.client_id}, test_id={payload.test_id}, section_id={payload.section_id}")
